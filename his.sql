...
INSERT INTO `prescription_drug_detail` VALUES (2, 1, 29, '口服', '5g', '一日二次', 5, 2, 1, NULL);
...
INSERT INTO `prescription_drug_detail` VALUES (6, 52, 23, '静脉注射', '100ml', '一日一次', 1, 2, 0, NULL);
INSERT INTO `prescription_drug_detail` VALUES (7, 52, 30, '静脉注射', '200ml', '一日一次', 1, 2, 0, NULL);
...
INSERT INTO `prescription_drug_detail` VALUES (11, 54, 9, '口服', '1g', '一日三次', 1, 2, 0, NULL);
INSERT INTO `prescription_drug_detail` VALUES (12, 54, 33, '口服', '2g', '一日三次', 1, 2, 0, NULL);
...
CREATE TABLE `register`  (
  ...
  `operator_id` int(10) DEFAULT NULL COMMENT '挂号员id',
  `create_time` datetime DEFAULT NULL COMMENT '挂号时间',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `register` VALUES (2, 600605, '杜甫', '71', '110101199003073634', '1900-01-02', 17, '岁', '雄安', '2019-03-19', '下午', '1', 2, 8, 1, 2, 301, '2019-03-18 09:21:26');
...
INSERT INTO `register` VALUES (6, 600605, '李贺', '71', '110101199003078937', '1900-01-02', 67, '岁', '长沙', '2019-03-19', '上午', '1', 1, 1, 1, 1, 301, '2019-03-19 10:09:35');
